    ...
    export default {
        ...
        methods: {
            ...
            getList(pageNum) {
                ...
                this.$request.get(`/advertisement/personSelectPage`, {
                    params: {
            ...
            save(){
                this.$refs.formRef.validate((valid) => {
                    if (valid) {
                        this.$request({
                            url: this.form.id ? '/advertisement/personUpdate' : '/advertisement/personAdd',
            ...
            // 根据id删除
            del(id) {
                this.$request.delete(`/advertisement/personDelete/${id}`).then(res=>{
                    if(res.code===200){
                        this.$message.success(res.msg)
