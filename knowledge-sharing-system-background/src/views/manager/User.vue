        ...
        <div class="table">
            <el-table :data="tableData" strip @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="vipStatus" label="VIP状态" show-overflow-tooltip>
                    <template v-slot="scope">
                        <div>
                          <el-tooltip v-if="scope.row.vipStatus===1"  class="item" effect="dark" content="点击设置为非会员"
                                       placement="top">
                          ...
                          <el-tooltip v-if="scope.row.vipStatus!==1"  class="item" effect="dark" content="点击设置为会员" placement="top">
                ...
                <el-table-column label="操作" align="center" width="250">
                    <template v-slot="scope">
                        <el-button v-if="isRole" size="mini" type="primary" plain @click="setUser(scope.row)">设为管理员
                        </el-button>
...
<script>
    export default {
        ...
        methods: {
            ...
            setUser(row) {
                this.$request.put("/super/updateUserRoleToAdmin", row).then(res => {
